...
variable "boot_disk_type_map" {
  description = "Map of specific disk types to specific instance sequence numbers"
  type        = map(any)
  default     = {}
}
